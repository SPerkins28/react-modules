        ...
        <Container className="main">
            <Row>
                <Col xs="12">
                    ...
                    <dl>
                        <dt>Can use state</dt>
                        <dd>With the 'useState' hook, funcitonal components can now both render a display to the page and update the information to be shown.</dd>
                        <dt>No 'this' keyword</dt>
                        <dd>Older class components use 'this', funcitonal components have no 'this' object.</dd>
                        <dt>Can use effects</dt>
                        <dd>With the 'useEffect' hook, functional components can perform side effects with an props or state changes.</dd>
                        <dt>return()</dt>
...
const HelloWorld = function () {
    return(
        <div>
            <Card>
                <img width="100%" height="280px" src="https://i/ytimg/com/vi/BwAakF_VUVU8/maxresdefault.jpg" alt="Card cap" />
                    <CardBody>
