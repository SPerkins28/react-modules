        ...
        <div className="main">
            <div className="mainDiv">
                ...
                <dl>
                    ...
                    <dd>It's not. It's acutally closer to JavaScript.</dd>
                    <dt>React Elements</dt>
                    <dd>These are used to contruct and update the DOM, or what you see on the screen.</dd>
                    <dt>Not Require</dt>
                    <dd>You can write in vanilla JS, but most sane poeple use JSX.</dd>
                </dl>
                <hr />
                <NormalComponent />
...
const CreateElementComponent = () => {
    return(
        React.createElement('div', { style: { border: '2px solid black' } },
            ...
            React.createElement('p', null, 'This was constructed with CreatElement Calls in the return.'),
